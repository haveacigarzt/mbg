...
const DialogHapusSekolah = ({ children, onSuccess, id, nama }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => setOpen(val)}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-lg me-7">Apakah Anda yakin ingin menghapus sekolah ini?</DialogTitle>
          <DialogDescription>Tindakan ini akan secara permanen menghapus sekolah {nama} dari server.</DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <DialogClose asChild>
